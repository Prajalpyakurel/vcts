...
import { eventColumns } from '@/pages/backend/event/index/partials/columns';
import { EventPagination } from '@/pages/backend/event/types';
import { eventCreate, eventIndex } from '@/routes';
...
export default function Index({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs} title="Event" flash={flash}>
                ...
                <div className="w-full">
                    <div className="flex items-center justify-between py-4">
                        ...
                        <div className={'flex items-center gap-3'}>
                            <Button
                                onClick={() => router.visit(eventCreate().url)}
                            >
                                <PlusIcon />
                                Add New
                            </Button>

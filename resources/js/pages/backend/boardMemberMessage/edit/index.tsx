...
import { boardMemberMessageIndex, boardMemberMessageUpdate } from '@/routes';
...
import {
    BoardMemberMessage,
} from '@/pages/backend/boardMemberMessage/types';
...
export default function Edit({
    ...
    const { data, setData, post, errors, processing } = useForm({
        image: null,
        name: boardMemberMessage?.name,
        designation: boardMemberMessage.designation,
        order_no: boardMemberMessage.order_no,
        message: boardMemberMessage.message,
        status: boardMemberMessage?.status,
    });

    function submit(e: React.FormEvent) {
        e.preventDefault();
        post(boardMemberMessageUpdate(Number(boardMemberMessage.id)).url, {
            forceFormData: true,
        });
    }
    return (
        <AppLayout title="Edit Board Member Message" breadcrumbs={breadcrumbs} flash={flash}>
            <div className="flex flex-col gap-4 p-4">
                <div className="max-w-4xl">
                    ...
                    >
                        <Card>
                            <CardHeader>
                                <CardTitle>Edit Board Member Message</CardTitle>
                            </CardHeader>

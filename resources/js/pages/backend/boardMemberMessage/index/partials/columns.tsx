...
import { boardMemberMessageDestroy, boardMemberMessageEdit } from '@/routes';
...
export const boardMemberMessageColumns: ColumnDef<BoardMemberMessage>[] = [
    {
        id: 'sn',
        header: 'S.N',
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                <span className="p-3">
                    <img
                        src={image ? `/storage/${image}` : '/assets/no_image.png'}
                        alt={row.original.name || 'board-member-image'}
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <div className="w-48" title={row.getValue('designation')}>
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                            onClick={() =>
                                router.visit(
                                    boardMemberMessageEdit(Number(row.original.id)),
                                )
                            }
                        >
                        ...
                        <DeleteConfirmDialog
                            onConfirm={() =>
                                router.delete(
                                    boardMemberMessageDestroy(Number(row.original.id)),
                                )
                            }
                        />
                    </DropdownMenuContent>

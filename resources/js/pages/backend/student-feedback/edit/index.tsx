...
import { studentFeedbackIndex, studentFeedbackUpdate } from '@/routes';
...
export default function EditHeroSection({
    ...
    const { data, setData, post, errors, processing } = useForm({
        image: null,
        name: studentFeedback?.name,
        email: studentFeedback?.email,
        feedback: studentFeedback?.feedback,
        student_course: studentFeedback?.student_course,
        status: studentFeedback?.status,
    });

    function submit(e: React.FormEvent) {
        e.preventDefault();
        post(studentFeedbackUpdate(Number(studentFeedback.id)).url, {
            forceFormData: true,
        });
    }
    return (
            ...
            <div className="flex flex-col gap-4 p-4">
                <div className="max-w-4xl">
                    ...
                    >
                        <Card>
                            <CardHeader>
                                <CardTitle>Edit Student Feedback</CardTitle>
                            </CardHeader>

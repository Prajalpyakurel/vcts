                ...
                <div className="mb-12 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
                    <div>
                        ...
                        <h2 className="text-3xl font-bold text-gray-900 md:text-4xl">
                            Explore Our Featured <span className="text-[#b8112e]">Programs</span>
                        </h2>
                    </div>
                    <Link
                        href="/programs"
                    ...
                    {courses.map((program) => (
                        ...
                        >
                            ...
                            <div className="relative h-52 overflow-hidden">
                                <img
                                    src={program.image ? `/storage/${program.image}` : '/assets/images/blog/blog_8.png'}
                                    alt={program.name}
                            ...
                            <div className="flex flex-1 flex-col p-5">
                                {/* University */}
                                <span className="mb-2 inline-flex items-center rounded-lg bg-rose-50 px-2.5 py-1 text-xs font-semibold text-[#b8112e]">
                                    {program.university}
                                </span>
                                ...
                                <div className="flex items-center justify-between border-t border-gray-100 pt-4">
                                    <div className="flex items-center gap-1.5 text-sm text-gray-500">
                                        ...
                                        <span className="font-medium">{program.total_credit_hours} Credits</span>
                                    </div>

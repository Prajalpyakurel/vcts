...
import { heroSectioncreate, heroSectionindex, heroSectionstore } from '@/routes';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: heroSectioncreate().url },
];
                        ...
                        <Card>
                            ...
                            <CardContent className="grid gap-6">
                                ...
                                <div className="grid gap-2">
                                    <Label htmlFor="image">
                                        Slide Image (shown on the right)
                                    </Label>
                                    <Input
                                        id="image"
                                        type="file"

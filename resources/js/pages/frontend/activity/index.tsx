import { activityShow } from '@/actions/App/Http/Controllers/Frontend/IndexController';
...
export default function Index({
    ...
    activities: InformationPagination;
    recentInformations: InformationPagination;
}) {
    const breadcrumbs = [
        { title: 'Home', href: '/', isActive: false },
        { title: 'Activity', href: '/activities', isActive: true },
    ];
                ...
                <aside className="max-w-form-xl w-full">
                    <div className="shadow-blog rounded bg-white p-5">
                        ...
                        <ul className="space-y-3">
                            {recentInformations.data.length > 0
                                ? recentInformations.data.map((act) => (
